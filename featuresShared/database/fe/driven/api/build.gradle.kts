...
sqldelight {
    databases {
        create("SnagDatabase") {
            packageName = "cz.adamec.timotej.snag.featuresShared.database.fe.driven.api.db"
            val sqldelightDir =
                "src/commonMain/sqldelight/cz/adamec/timotej/snag/featuresShared/database/fe/driven/api"
