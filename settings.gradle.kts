...
include(":featShared:database:fe:driven:api")
include(":featShared:database:fe:driven:impl")
include(":featShared:database:fe:driven:test")
include(":featShared:database:be:driven:api")
include(":featShared:database:be:driven:impl")
include(":featShared:database:be:driven:test")
include(":core:business:rules:api")
include(":core:business:rules:impl")
include(":lib:design:fe:api")
include(":lib:design:fe:impl")
...
include(":feat:sync:business:model")
include(":feat:sync:be:app:api")
include(":feat:sync:be:app:impl")
include(":feat:sync:be:app:model")
include(":feat:sync:fe:ports")
include(":feat:sync:fe:app:api")
include(":feat:sync:fe:app:impl")
include(":feat:sync:fe:app:model")
...
include(":featShared:storage:be:driven:impl")
include(":featShared:storage:fe:driven:impl")
