...
include(":feat:projects:fe:driving:nonWear")
include(":feat:projects:fe:driving:wear")
...
include(":feat:authentication:fe:driven:nonWear")
include(":feat:authentication:fe:driven:wear")
