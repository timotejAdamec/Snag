...
import cz.adamec.timotej.snag.structures.fe.app.impl.internal.CascadeDeleteStructuresByProjectIdUseCaseImpl
...
val structuresAppModule =
    module {
        ...
        factoryOf(::CascadeDeleteStructuresByProjectIdUseCaseImpl) bind CascadeDeleteStructuresByProjectIdUseCase::class
