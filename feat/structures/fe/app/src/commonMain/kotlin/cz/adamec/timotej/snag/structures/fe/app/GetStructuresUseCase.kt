...
package cz.adamec.timotej.snag.structures.fe.app
...
import cz.adamec.timotej.snag.structures.fe.app.internal.LH
...
class GetStructuresUseCase(
    ...
    operator fun invoke(projectId: Uuid): Flow<OfflineFirstDataResult<List<Structure>>> {
