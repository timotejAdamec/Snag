...
package cz.adamec.timotej.snag.structures.be.driven.internal
...
internal class InMemoryStructuresLocalDataSource : StructuresLocalDataSource {
    ...
    override suspend fun getStructures(projectId: Uuid): List<Structure> =
        structures.filter { it.projectId == projectId }
}
