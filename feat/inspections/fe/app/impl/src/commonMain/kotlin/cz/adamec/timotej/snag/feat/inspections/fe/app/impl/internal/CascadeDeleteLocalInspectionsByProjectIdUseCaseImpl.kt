...
internal class CascadeDeleteLocalInspectionsByProjectIdUseCaseImpl(
    private val inspectionsDb: InspectionsDb,
) : CascadeDeleteLocalInspectionsByProjectIdUseCase {
    override suspend operator fun invoke(projectId: Uuid) {
        inspectionsDb.deleteInspectionsByProjectId(projectId)
    }
}
