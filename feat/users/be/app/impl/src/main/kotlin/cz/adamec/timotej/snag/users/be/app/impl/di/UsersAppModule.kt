...
import cz.adamec.timotej.snag.users.be.app.impl.internal.GetUsersByRoleUseCaseImpl
...
val usersAppModule =
    module {
        ...
        factoryOf(::GetUsersByRoleUseCaseImpl) bind GetUsersByRoleUseCase::class
