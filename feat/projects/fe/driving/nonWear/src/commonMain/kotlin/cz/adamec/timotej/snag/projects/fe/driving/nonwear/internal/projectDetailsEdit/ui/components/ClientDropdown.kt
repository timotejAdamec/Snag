...
package cz.adamec.timotej.snag.projects.fe.driving.nonwear.internal.projectDetailsEdit.ui.components
...
import snag.feat.projects.fe.driving.nonwear.generated.resources.client_label
import snag.feat.projects.fe.driving.nonwear.generated.resources.create_new_client
import snag.feat.projects.fe.driving.nonwear.generated.resources.none
    ...
    ExposedDropdownMenuBox(
        ...
        ExposedDropdownMenu(
            ...
            availableClients.forEach { frontendClient ->
                DropdownMenuItem(
                    text = { Text(frontendClient.name) },
                    onClick = {
                        onSelectClient(frontendClient.id, frontendClient.name)
                        expanded = false
                    },
                )
            }
