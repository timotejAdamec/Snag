...
class CanAssignUserToProjectRuleTest {
    private val rule = CanAssignUserToProjectRule()
    ...
    @Test
    fun `returns false for SERVICE_WORKER`() {
        assertFalse(rule(createUser(role = UserRole.SERVICE_WORKER)))
    }
